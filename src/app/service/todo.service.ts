...
//private local = "http://betufa55.com";
  ...
  saveLink(data,link,id_post,page_name,page_post,link_like){
    return this.http2.post<contactData>(this.local+'/api_nubshare/dataAdjust.php',{ac:"save_link",data:data,link:link,time_stamp:id_post,name_page:page_name,post_message:page_post,link_like:link_like,m_id:'1'});
  }

  getPost(m_id){
    return this.http2.post<contactData>(this.local+'/api_nubshare/dataAdjust.php',{ac:"getPost",m_id:m_id});
  }
  ...
  getDataShare(id_post){
    return this.http2.post<contactData>('http://localhost:3000/getShare/'+id_post,{});
  }

  getDataComment(link,data_id){
    return this.http2.post<contactData>('http://localhost:3000/getComment/'+encodeURIComponent(link),{data_id:data_id});
  }
  ...
  saveUserWin(data_id,type_event,user_id,user_name){
    return this.http2.post<contactData>(this.local+'/api_nubshare/dataAdjust.php',{ac:"save_user_win",data_id:data_id,user_id:user_id,user_name:user_name,type_event:type_event});
  }
  getUserWin(data_id,type_event){
    return this.http2.post<contactData>(this.local+'/api_nubshare/dataAdjust.php',{ac:"get_user_win",data_id:data_id,type_event:type_event});
  }
}
